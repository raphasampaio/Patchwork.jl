...
@testset "Integration Tests" begin
    @testset "generate_dashboard creates file" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "test_dashboard.html")
    ...
    @testset "generate_dashboard with Chart.js example" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "chartjs_dashboard.html")
    ...
    @testset "generate_dashboard with multiple tabs" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "multi_tab_dashboard.html")
    ...
    @testset "generate_dashboard with custom styling" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "styled_dashboard.html")
    ...
    @testset "generate_dashboard with complex metadata" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "complex_dashboard.html")
    ...
    @testset "generate_dashboard with empty tab" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "empty_tab_dashboard.html")
    ...
    @testset "generate_dashboard file overwrite" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "overwrite_test.html")
    ...
    @testset "generate_dashboard with special characters in paths" begin
        mktempdir() do tmpdir
            ...
            subdir = joinpath(tmpdir, "test directory")
            mkpath(subdir)
    ...
    @testset "generate_dashboard validates HTML structure" begin
        mktempdir() do tmpdir
            output_path = joinpath(tmpdir, "validate.html")
